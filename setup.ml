...
(* OASIS_START *)
(* DO NOT EDIT (digest: 783f7d20f630e4341efca14eaded51e3) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.cmd_main =
              [
                 (OASISExpr.EBool true,
                   ("osh", ["omake.osh"; "PREFIX="; "COMMAND="]))
              ];
            cmd_clean =
              [
                 (OASISExpr.EBool true,
                   Some (("osh", ["omake.osh"; "PREFIX="; "COMMAND=clean"])))
              ];
       ...
       CustomPlugin.main
         {
            CustomPlugin.cmd_main =
              [
                 (OASISExpr.EBool true,
                   ("osh", ["omake.osh"; "PREFIX="; "COMMAND=install"]))
              ];
       ...
       CustomPlugin.main
         {
            CustomPlugin.cmd_main =
              [
                 (OASISExpr.EBool true,
                   ("osh", ["omake.osh"; "PREFIX="; "COMMAND=uninstall"]))
              ];
            cmd_clean = [(OASISExpr.EBool true, None)];
            cmd_distclean = [(OASISExpr.EBool true, None)]
         };
          ...
          CustomPlugin.Build.clean
            {
               ...
               cmd_clean =
                 [
                    (OASISExpr.EBool true,
                      Some
                        (("osh", ["omake.osh"; "PREFIX="; "COMMAND=clean"])))
                 ];
               cmd_distclean = [(OASISExpr.EBool true, None)]
            };
          CustomPlugin.clean
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "ÝÎ´áðUã\131^Èwí\130ü{b";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
