...
(* OASIS_START *)
(* DO NOT EDIT (digest: 815887730ca2f59a6dff20d698f4ddb4) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.cmd_main =
              [
                 (OASISExpr.EBool true,
                   ("osh", ["omake.osh"; "PREFIX=$prefix"; "COMMAND="]))
              ];
            cmd_clean =
              [
                 (OASISExpr.EBool true,
                   Some
                     (("osh",
                        ["omake.osh"; "PREFIX=$prefix"; "COMMAND=clean"])))
              ];
       ...
       CustomPlugin.main
         {
            CustomPlugin.cmd_main =
              [
                 (OASISExpr.EBool true,
                   ("osh",
                     ["omake.osh"; "PREFIX=$prefix"; "COMMAND=install"]))
              ];
       ...
       CustomPlugin.main
         {
            CustomPlugin.cmd_main =
              [
                 (OASISExpr.EBool true,
                   ("osh",
                     ["omake.osh"; "PREFIX=$prefix"; "COMMAND=uninstall"]))
              ];
            cmd_clean = [(OASISExpr.EBool true, None)];
            cmd_distclean = [(OASISExpr.EBool true, None)]
         };
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "q\194\031\132eQl\225\174\228\156\185\135Rg\217";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
